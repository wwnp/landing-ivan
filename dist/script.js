...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_test__WEBPACK_IMPORTED_MODULE_5__["default"])('.test_block');
});
        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              ...
              el.forEach(function (checkbox, index2) {
...
/* harmony import */ var _checkNumInputs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./checkNumInputs */ "./src/js/modules/checkNumInputs.js");
...
var forms = function forms(state) {
  ...
  var modalCalcEnd = document.querySelector('[data-modal-calc-end]');
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_12__["default"])('input[name="user_phone"]');
  var msg = {
    loading: 'Загрузка...',
    success: 'Thanks',
    fail: 'Error'
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        return statusMsg.textContent = msg.fail;
      }).finally(function () {
        clearState(state);
        clearInputs();
        setTimeout(function () {
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  var tabSelectorSliced = tabSelector.slice(1, tabSelector.length);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var test = function test(blockSelector) {
  var direction = "";
  var oldY = 0;
  var testBlock = document.querySelector(blockSelector);
  testBlock.addEventListener('mousedown', function (e) {
    var modMoveEventHandler = moveEventHandler.bind(e);
    testBlock.addEventListener('mousemove', modMoveEventHandler);
    testBlock.addEventListener('mouseup', function () {
      console.log(123);
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemaining = function getTimeRemaining(endTime) {
    ...
    var hours = Math.floor(time / 1000 / 60 / 24 % 24);
    var days = Math.floor(time / 1000 / 60 / 24 / 30);
    return {
      'total': time,
      'days': days,
      'hours': hours,
